...
st.markdown('<style>.css-16idsys p{font-size: 20px;}.eex3ynb0{visibility: hidden;}.css-1gulkj5{height: 200px;background-color: #2125bae3;}.css-noeb3a{position: absolute;right: 336px;top: 165px;color: white;}.e1ewe7hr10{position: absolute;right: 302px;top: 45%;}.eqdbnj012{position: absolute;right: 282px;top: 28%;color: white;}</style>', unsafe_allow_html=True)
