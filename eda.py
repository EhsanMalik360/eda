...
st.title('ReportRealm')
uploaded_file = st.file_uploader("Convert your CSVs to interactive reports", type=['csv', 'xlsx'])
#st.markdown('<style>.css-16idsys p{font-size: 20px;}.eex3ynb0{visibility: hidden;}.css-1gulkj5{height: 200px;background-color: #2125bae3;}.css-noeb3a{position: absolute;right: 470px;top: 165px;color: white;}.e1ewe7hr10{position: absolute;right: 570px;top: 45%; display: none;}.eqdbnj012{position: absolute;right: 425px;top: 28%;color: #ffffff;}.css-9ycgxx{margin-left:375px; color:#ffffff;}.css-1aehpvj{display: none;}.css-7ym5gk{display: none;}@media only screen and (max-width: 600px) {.css-9ycgxx{margin-left: 60px;margin-top:60px;}}</style>', unsafe_allow_html=True)
